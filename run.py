...
if __name__ == "__main__":
    ...
    # pipeline(input_image_path='test_data/downsampled_image.bmp', output_image_path="error_free/obtained.bmp",
            #  source_dna_path="error_free/o.fasta", target_dna_path="error_free/p.fasta", random_seed=966518)
    ...
    for f in os.listdir(directory_path):
        ...
        pipeline(input_image_path=file_name, output_image_path="error/obtained.bmp",
                source_dna_path="error/o.fasta", target_dna_path="error/p.fasta", random_seed=596789448)
# 966518
# 59648
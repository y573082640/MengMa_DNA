...
if __name__ == "__main__":
    ...
    pipeline(input_image_path='expected.bmp', output_image_path="error_free/obtained.bmp",
    ...
    pipeline(input_image_path="expected.bmp", output_image_path="error/obtained.bmp",
